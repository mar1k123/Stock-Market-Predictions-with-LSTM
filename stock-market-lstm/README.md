...
│                         stock_market_lstm and configuration for tools like black
│
...
│
└── stock_market_lstm   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes stock_market_lstm a Python module
    │
